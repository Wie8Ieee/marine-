...
"""
    ...
    def test_v9_path_contract_source(self):
        source = Path("tmp/frcnn_checkpoint_metadata_smoke/smoke.py").read_text(encoding="utf-8")
        self.assertIn('ROOT = WORKING / "frcnn_smoke_v9_export"', source)
        self.assertIn('RUNTIME = WORKING / "frcnn_smoke_v9_runtime"', source)
