...
"""
    ...
    def test_v11_path_contract_source(self):
        source = Path("tmp/frcnn_checkpoint_metadata_smoke/smoke.py").read_text(encoding="utf-8")
        self.assertIn('ROOT = WORKING / "frcnn_smoke_v11_export"', source)
        self.assertIn('RUNTIME = WORKING / "frcnn_smoke_v11_runtime"', source)
        self.assertIn('REFERENCE_OUTPUT = ARTIFACTS / "reference_run"', source)
        ...
        self.assertIn('DIAGNOSTICS / "reference"', source)
